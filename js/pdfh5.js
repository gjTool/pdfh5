	...
	Pdfh5.prototype = {
		...
		renderCanvas: function (page, viewport, pageNum, num, container, options) {
			...
			return page.render(renderObj).promise.then(function () {
				...
				// var img0 = self.container.querySelector(".pageContainer" + pageNum + " .canvasImg" + pageNum);
				// if (container && !img0) {
